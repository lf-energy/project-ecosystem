...
None. OpenGridFM is an AI/ML research platform and does not directly implement grid communication or data model standards. It consumes MATPOWER-format network data as input.
...
None. OpenGridFM is a standalone research and development platform. Foundation models developed using OpenGridFM could eventually be embedded within EMS, ADMS, or planning tools, but OpenGridFM itself is not a component of those systems.
